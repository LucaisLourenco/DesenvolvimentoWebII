            ...
            <div class="col" >
                <div class="mb-3" data-toggle="buttons">
                    <label class="btn btn-primary {{ $errors->has('ativo') ? 'is-invalid' : '' }}">
                        <input type="radio" data-toggle="button" name="ativo" id="option1" value="1" {{ old('ativo') == '1' ? 'checked' : ' '}}> Ativo
                    </label>
                    <label class="btn btn-danger {{ $errors->has('ativo') ? 'is-invalid' : '' }}">
                        <input type="radio" data-toggle="button" name="ativo" id="option2" value="0" {{ old('ativo') == '0' ? 'checked' : ' '}}> Desabilitado
                    </label>
                    @if($errors->has('ativo'))
        ...
        <div class="row">
            <div class="col" >
                <div class="form-floating mb-3">
                    ...
                    @endif
                    <label for="eixo_id">Eixo do professor</label>
                </div>
            </div>
        </div>
        <div class="row">
