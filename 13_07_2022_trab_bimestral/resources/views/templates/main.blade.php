...
<html lang="pt-br">
    <head>
        ...
        <title>Instituto Federal do Paraná - @yield('titulo')</title>
    ...
    <body>
        <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-primary">
            <div class="container-fluid">
                <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                        <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917l-7.5-3.5Z"/>
                        <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466 4.176 9.032Z"/>
                    </svg>
                        <span class="ms-3 fs-5">Instituto Federal do Paraná</span>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown ps-1">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                                ...
                                <span class="ps-1 text-white">Corpo</span>
                            </a>
                        ...
                        <li class="nav-item dropdown ps-1">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                                ...
                                <span class="ps-1 text-white">Acadêmico</span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{route('disciplina_professors.index')}}" class="dropdown-item">Docência</a></li>
                            </ul>
                        </li>
        ...
        <nav class="navbar fixed-bottom navbar-dark bg-primary">
            <div class="container-fluid">
                <span class="text-white fw-light">&copy; Lucas Gomes Lourenço</span>
            </div>
        </nav>
    </body>
