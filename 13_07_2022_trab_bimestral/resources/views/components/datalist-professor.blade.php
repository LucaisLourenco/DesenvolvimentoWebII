        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    @foreach($eixos as $dados)
                        @if( $item['eixo_id'] == $dados->id)
                    ...
                    <td>
                        <a href= "{{ route('professores.edit', $item) }}" class="btn btn-success">
                    ...
                    <form action="{{ route('professores.destroy', $item) }}" method="POST" id="form_{{$item['id']}}">
                        @csrf
                        @method('DELETE')
                    </form>
                </tr>
