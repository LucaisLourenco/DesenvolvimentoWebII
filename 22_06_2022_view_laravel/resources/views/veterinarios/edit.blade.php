...
<form action="{{ route('veterinarios.update', $transmitter['crmv']) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col" >
        ...
        <div class="col" >
            <div class="form-floating mb-3">
                <input 
                    ...
                    value="{{$transmitter['especialidade']}}"
                />
                <label for="email">Especialidade do Veterinário</label>
            </div>
        </div>
    </div>
    <div class="row">
